namespace Intelligent_Calculator_Core
{
	partial class frmBPTB32
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmBPTB32));
			...
			this.groupBoxKQ.Location = new System.Drawing.Point(4, 370);
			this.groupBoxKQ.Name = "groupBoxKQ";
			this.groupBoxKQ.Size = new System.Drawing.Size(399, 119);
			...
			this.groupBoxNhap.Location = new System.Drawing.Point(4, 56);
			...
			this.labelName.Size = new System.Drawing.Size(385, 16);
			this.labelName.TabIndex = 12;
			this.labelName.Text = "GIẢI BẤT PHƯƠNG TRÌNH BẬC 3 (ax³ + bx² + cx +d ≤ 0)";
			// 
			// frmBPTB32
			// 
			...
			this.Text = "Giải Bất Phương Trình Bậc 3 ax³ + bx² + cx + d ≤ 0";
			this.Load += new System.EventHandler(this.frmBPTB32_Load);
