...
{
	public partial class frmB3ChiaB1 : Form
	{
		public frmB3ChiaB1()
		{
			InitializeComponent();
		...
		private void frmB3ChiaB1_Load(object sender, EventArgs e)
		{
		...
		{
			if ((txtA.Text == "") && (txtB.Text == "") && (txtC.Text == "") && (txtD.Text == "") && (txtAA.Text == "") && (txtBB.Text == ""))
				btnLamMoi.Enabled = false;
			else
			...
			else
			{
				try
				{
					...
					else
					{
						...
						double dblO5 = dblNghiemPTB1 * dblGiaTriA;
						double dblO9 = dblGiaTriB + dblO5;
						double dblO6 = dblNghiemPTB1 * dblO9;
						double dblO10 = dblGiaTriC + dblO6;
						double dblO7 = dblNghiemPTB1 * dblO10;
						double dblO11 = dblGiaTriD + dblO7;

						if (dblO11 == 0)
						{
							txtKQ.Text = "= " + (dblGiaTriA / dblGiaTriAA).ToString() + "x² + " + (dblO9 / dblGiaTriAA).ToString() + "x + " + (dblO10/dblGiaTriAA).ToString();
						}
						else
						{
							txtKQ.Text = "= (" + (dblGiaTriA / dblGiaTriAA).ToString() + "x² + " + (dblO9 / dblGiaTriAA).ToString() + "x + " + (dblO10 / dblGiaTriAA).ToString() + ") dư " + dblO11.ToString();
						}
					}
				}
				catch
