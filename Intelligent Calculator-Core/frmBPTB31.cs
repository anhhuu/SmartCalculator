...
{
	public partial class frmBPTB31 : Form
	{
		public frmBPTB31()
		{
			InitializeComponent();
		...
		private void frmBPTB31_Load(object sender, EventArgs e)
		{
					...
					if (dblGiaTriA == 0)
					{
						...
						else if (dblGiaTriB > 0)
						{
							...
							else
							{
								...
								txtKQ.Text = "Bất phương trình có nghiệm:";
								txtX1.Text = "x ≤ " + fNghiem1.ToString() + " hoặc " + fNghiem2.ToString() + " ≤ x";
							}
						}
						else
						{
							...
							{
								double x = -dblGiaTriC / (2 * dblGiaTriB);
								txtKQ.Text = "Bất phương trình có nghiệm:";
							...
							else
							{
								...
								txtX1.Text = fNghiem1.ToString() + " ≤ x ≤ " + fNghiem2.ToString();
							}
						}
					}
					else
					{
						...
						if (dblH > 0)
						{
							...
							if (dblGiaTriX1 > 0)
							{
								...
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
									txtX1.Text = "x ≤ " + dblGiaTriX1.ToString();
								}
								else
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
							...
							{
								if ((dblGiaTriA + dblGiaTriB + dblGiaTriC + dblGiaTriD) > 0)
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
									txtX1.Text = "x ≥ 0";
								}
						...
						else if (dblF == 0 && dblG == 0 && dblH == 0)
						{
							...
							if (dblDTrenA < 0)
							{
								dblDTrenAMu1Phan3 = (1) * dblDTrenAMu1Phan3;
							}
							if (dblDTrenA > 0)
							{
							...
							// Hiển thị giá trị các nghiệm
							MessageBox.Show(dblGiaTriX1.ToString());
							if (dblGiaTriX1 > 0)
							{
								if (dblGiaTriD > 0)
								{
						...
						else if (dblH <= 0)
						{
							...
							// Hiển thị giá trị các nghiệm
							if ((dblGiaTriX1 > dblGiaTriX2) && (dblGiaTriX2 > dblGiaTriX3))
							{
								double u = dblGiaTriX1 + 1;
								if (dblGiaTriA * u * u * u + dblGiaTriB * u * u + dblGiaTriC * u + dblGiaTriD > 0)
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
									txtX1.Text = "x ≥ " + dblGiaTriX1.ToString() + "      hoặc";
									txtX2.Text = dblGiaTriX3.ToString() + " ≤ x ≤ " + dblGiaTriX2.ToString();
								}
								else
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
									txtX1.Text = "x ≥ " + dblGiaTriX3.ToString() + "      hoặc";
									txtX2.Text = dblGiaTriX2.ToString() + " ≤ x ≤ " + dblGiaTriX1.ToString();
								}
							}
							else if ((dblGiaTriX1 < dblGiaTriX2) && (dblGiaTriX2 < dblGiaTriX3))
							{
								double u = dblGiaTriX3 + 1;
								if (dblGiaTriA * u * u * u + dblGiaTriB * u * u + dblGiaTriC * u + dblGiaTriD > 0)
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
									txtX1.Text = "x ≥ " + dblGiaTriX3.ToString() + "      hoặc";
									txtX2.Text = dblGiaTriX1.ToString() + " ≤ x ≤ " + dblGiaTriX2.ToString();
								}
								else
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
									txtX1.Text = "x ≤ " + dblGiaTriX1.ToString() + "      hoặc";
									txtX2.Text = dblGiaTriX2.ToString() + " ≤ x ≤ " + dblGiaTriX3.ToString();
								}
							}
							else if ((dblGiaTriX1 < dblGiaTriX3) && (dblGiaTriX3 < dblGiaTriX2))
							{
								double u = dblGiaTriX2 + 1;
								if (dblGiaTriA * u * u * u + dblGiaTriB * u * u + dblGiaTriC * u + dblGiaTriD > 0)
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
									txtX1.Text = "x ≥ " + dblGiaTriX2.ToString() + "      hoặc";
									txtX2.Text = dblGiaTriX1.ToString() + " ≤ x ≤ " + dblGiaTriX3.ToString();
								}
								else
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
							...
							else if ((dblGiaTriX3 < dblGiaTriX1) && (dblGiaTriX1 < dblGiaTriX2))
							{
								double u = dblGiaTriX2 + 1;
								if (dblGiaTriA * u * u * u + dblGiaTriB * u * u + dblGiaTriC * u + dblGiaTriD > 0)
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
									txtX1.Text = "x ≥ " + dblGiaTriX2.ToString() + "      hoặc";
									txtX2.Text = dblGiaTriX3.ToString() + " ≤ x ≤ " + dblGiaTriX1.ToString();
								}
								else
								{
									txtKQ.Text = "Bất phương trình có nghiệm:";
							...
							else if ((dblGiaTriX2 < dblGiaTriX3) && (dblGiaTriX3 < dblGiaTriX1))
							{
								double u = dblGiaTriX1 + 1;
								if (dblGiaTriA * u * u * u + dblGiaTriB * u * u + dblGiaTriC * u + dblGiaTriD > 0)
								{
							...
							else if ((dblGiaTriX2 < dblGiaTriX1) && (dblGiaTriX1 < dblGiaTriX3))
							{
								double u = dblGiaTriX3 + 1;
								if (dblGiaTriA * u * u * u + dblGiaTriB * u * u + dblGiaTriC * u + dblGiaTriD > 0)
								{
