...
{
	public partial class frmBPTB42 : Form
	{
		public frmBPTB42()
		{
			InitializeComponent();
		...
		private void frmBPTB42_Load(object sender, EventArgs e)
		{
						...
						else
						{
							if (dblB * dblGiaTriX1 / 2 - dblD < 0)
							{
								...
								else if (Delta1 == 0 && Delta2 < 0)
								{
									...
									txtX1.Text = "Bất phương trình có nghiệm:";
									txtX2.Text = "x = " + x12.ToString();
								}
								else if (Delta1 == 0 && Delta2 == 0)
								{
									double x12 = (-fBienSo2) / 2;
								...
								else if (Delta1 > 0 && Delta2 == 0)
								{
									...
									double x34 = -fBienSo5 / 2;
									txtKQ.Text = "Bất phương trình có nghiệm:";
									txtX1.Text = "x = " + x34.ToString() + "      hoặc";
									txtX2.Text = x2.ToString() + " ≤ x ≤ " + x1.ToString();
							...
							else
							{
								...
								double fBienSo2 = (dblB / 2 - Math.Sqrt(Math.Round(dblB * dblB / 4 - dblC + dblGiaTriX1, 8)));
								double fBienSo3 = dblGiaTriX1 / 2 - Math.Sqrt(Math.Round(dblGiaTriX1 * dblGiaTriX1 / 4 - dblE, 8));
								double fBienSo5 = (dblB / 2 + Math.Sqrt(Math.Round(dblB * dblB / 4 - dblC + dblGiaTriX1, 8)));
								double fBienSo6 = dblGiaTriX1 / 2 + Math.Sqrt(Math.Round(dblGiaTriX1 * dblGiaTriX1 / 4 - dblE, 8));
								double Delta1 = Math.Pow(fBienSo2, 2) - 4 * fBienSo3;
								double Delta2 = Math.Pow(fBienSo5, 2) - 4 * fBienSo6;
								...
								else if (Delta1 > 0 && Delta2 == 0)
								{
									...
									txtKQ.Text = "Bất phương trình có nghiệm:";
									txtX1.Text = "x = " + x34.ToString() + "      hoặc";
									txtX2.Text = x1.ToString() + " ≤ x ≤ " + x1.ToString();
